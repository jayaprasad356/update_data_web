...
define('DOMAIN_URL', 'https://localhost/update_data_web/'); /* chnage to your domain here - don't forget to add forward slash at the end of the URL like this "/" */
...
class Database
{
    ...
    private $db_name = "update_data";    // Change as required
